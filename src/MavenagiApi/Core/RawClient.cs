...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<MavenagiApi.Core.ApiResponse> MakeRequestAsync(
        MavenagiApi.Core.BaseRequest request,
    ...
    internal async Task<MavenagiApi.Core.ApiResponse> SendRequestAsync(
        MavenagiApi.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<MavenagiApi.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new MavenagiApi.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(MavenagiApi.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(MavenagiApi.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use MavenagiApi.Core.ApiResponse instead.")]
    internal record ApiResponse : MavenagiApi.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use MavenagiApi.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : MavenagiApi.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use MavenagiApi.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : MavenagiApi.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use MavenagiApi.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : MavenagiApi.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use MavenagiApi.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : MavenagiApi.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use MavenagiApi.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : MavenagiApi.Core.StreamRequest;
}
