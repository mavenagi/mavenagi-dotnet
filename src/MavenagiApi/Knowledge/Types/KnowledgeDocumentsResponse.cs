...
[Serializable]
public record KnowledgeDocumentsResponse
{
    /// <summary>
    /// The knowledge documents that match the search criteria. Content will not be included.
    /// </summary>
    [JsonPropertyName("knowledgeDocuments")]
    public IEnumerable<KnowledgeDocumentSearchResponse> KnowledgeDocuments { get; set; } =
        new List<KnowledgeDocumentSearchResponse>();
